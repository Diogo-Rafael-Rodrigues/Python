...
mark_label = Label()
mark_label.config(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 16, "bold"))
mark_label.grid(column=1, row=3)

# ------------------------BUTTONS---------------------------- #
button_start = Button(text="Start", command=star_timer, highlightthickness=10)
button_start.grid(column=0, row=2)

button_reset = Button(text="Reset",command=reset_timer, highlightthickness=10)
